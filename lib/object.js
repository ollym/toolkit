Object.defineProperties(Object, {
  ...
  enum: { value : function enum(object) {
    /**
  ...
  enum$: { value : function enum$(object) {
    /**
     * The self modification version of Object.enum. New methods are defined to the current object rather than a clone.
     *
     * @since 1.4.0
     * @param object The object we're going to wrap
     * @example
