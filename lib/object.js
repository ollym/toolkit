Object.defineProperties(Object, {
  ...
  forEach: { value: function(obj, callback, scope) {
    /**
  ...
  each: { value: function(obj, callback, scope) {
    /**
  ...
  map: { value : function(object, callback, scope) {
    /**
  ...
  map$: { value : function(obj, callback, scope) {
    /**
  ...
  filter: { value : function(object, callback, scope) {
    /**
  ...
  filter$: { value : function(obj, callback, scope) {
    /**
